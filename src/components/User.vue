...
<div>
  ...
  <slot v-if="isAuthenticate">
    ...
    <div class="form-group row justify-content-center">
      ...
      <div class="col-10 col-sm-8">
        <input type="text" v-model="userinfo.taxnumber" placeholder="NIF da facturação" v-validate="'numeric|required'" name="taxnumber" data-vv-as="Nif da faturação" class="form-control" :class="{ 'is-invalid': errors.has('taxnumber') }" />
