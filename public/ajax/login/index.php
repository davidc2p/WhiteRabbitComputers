...
<table>
    <tr>
        <td>
            ...
            <div>
            <!--[if mso]>
            <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="http://www.whiterabbitcomputers.com/AccountConfirmation/'.$ret[0]['uid'].'" style="height:40px;v-text-anchor:middle;width:300px;" arcsize="10%" stroke="f" fillcolor="#E5C41A">
                <w:anchorlock/>
            ...
            <td align="center" width="300" height="40" bgcolor="#E5C41A" style="-webkit-border-radius: 5px; -moz-border-radius: 5px; border-radius: 5px; color: #ffffff; display: block;">
                <a href="http://www.whiterabbitcomputers.com/AccountConfirmation/'.$ret[0]['uid'].'" style="font-size:16px; font-weight: bold; font-family:sans-serif; text-decoration: none; line-height:40px; width:100%; display:inline-block">
            ...
            $mail->AltBody = 'Link: '.'http://www.whiterabbitcomputers.com/AccountConfirmation/'.$ret[0]['uid'];
...
<table>
    <tr>
        <td>
            ...
            <div>
            <!--[if mso]>
            <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="http://www.whiterabbitcomputers.com/AccountConfirmation/'.$data[0]['uid'].'" style="height:40px;v-text-anchor:middle;width:300px;" arcsize="10%" stroke="f" fillcolor="#E5C41A">
                <w:anchorlock/>
                <center style="color: black;font-family:sans-serif;font-size:16px;font-weight:bold;">
            ...
            <table cellspacing="0" cellpadding="0"> <tr> 
            <td align="center" width="300" height="40" bgcolor="#E5C41A" style="-webkit-border-radius: 5px; -moz-border-radius: 5px; border-radius: 5px; color: #ffffff; display: block;">
                <a href="http://www.whiterabbitcomputers.com/AccountConfirmation/'.$data[0]['uid'].'" style="font-size:16px; font-weight: bold; font-family:sans-serif; text-decoration: none; line-height:40px; width:100%; display:inline-block">
                <span style="color: black;">
                    Reinicializar Password
                </span>
                </a>
            ...
            $mail->MsgHTML($CompleteMessage);
            //Replace the plain text body with one created manually
            $mail->AltBody = 'Link: '.'http://www.whiterabbitcomputers.com/AccountConfirmation/'.$data[0]['uid'];
